// git/guardarGit_Cat_E.js 
const axios = require('axios');
const fs = require('fs');
const path = require('path');

const GITHUB_REPO = 'Alegenio2/bot-fmg';
const RELATIVE_FILE_PATH = 'categorias/categoria_e.json'; // Ruta relativa dentro del repo
const LOCAL_FILE_PATH = path.join(__dirname, '..', RELATIVE_FILE_PATH);
const BRANCH = 'main';

const GH_TOKEN = process.env.GH_TOKEN;

async function guardarYSubirCatE() {
  ...
  try {
    ...
    await axios.put(
      ...
      {
        message: 'Actualización automática de categoria_e.json',
    ...
    console.log('✅ Archivo categoria_e.json actualizado en GitHub');
  } catch (error) {
