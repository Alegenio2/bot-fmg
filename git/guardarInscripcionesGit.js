...
const FILE_PATH = 'equipos_inscritos.json';
const BRANCH = 'main'; // o el branch que uses

const GH_TOKEN = process.env.GH_TOKEN;

async function guardarYSubirEquipos() {
  ...
  try {
    ...
    await axios.put(
      ...
      {
        message: 'Actualización automática de equipos_inscritos.json',
    ...
    console.log('✅ Archivo equipos_inscritos.json actualizado en GitHub');
  } catch (error) {
